...
-----END PRIVATE KEY-----`
    ...
    // Bootstrap sockets controllers
    // fs.readdirSync(path.normalize(__dirname + "/../") + "/app/sockets").forEach(function (file) {
    //   if (~file.indexOf(".js"))
    //     require(path.normalize(__dirname + "/../") + "/app/sockets/" + file).controller(io, socket);
    // });
  });
};
